...
const Camp = () => {
  return (
    ...
    >
      <div
        className={
          'hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]'
        }
      >
        <CampSite
        ...
        <CampSite
          ...
          subtitle={'Something in the Wilderness'}
          peopleJoined={'50+ Joined'}
        />
      </div>
      ...
      <div className={'flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6'}>
        <div
          className={
            'bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl'
          }
        >
